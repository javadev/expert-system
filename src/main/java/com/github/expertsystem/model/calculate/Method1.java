...
public class Method1 {
    ...
    private void midCriterionWeightsCalculate() {
        ...
        outPut.println();
        outPut.println(
                "Расчет коэффициентов весов показателей сравнения объектов ( формула: Qh = Σj (Qhj * Kj) )");
        outPut.println();
        for (int cr = 0; cr < Criterions.getSize(); cr++) {
            ...
            for (int ex = 0; ex < Experts.getSize(); ex++) {
                res +=
                        Experts.findExpert(ex).getCompetence()
    ...
    private void midMarksCalculate() {
        ...
        outPut.println();
        outPut.println(
                "Расчет средних значений оценок объектов ( формула: Xhi = Σj (Xhij * Qh * Kj) )");
        outPut.println();
                ...
                for (int ex = 0; ex < Experts.getSize(); ex++) {
                    ...
                    str =
                            str
                                    ...
                                    + formatter.format(Experts.findExpert(ex).getCompetence())
                                    + " * "
                                    + formatter.format(midCriterionWeights[cr])
                                    + ") + ";
                }
                str = str.substring(0, str.length() - 3) + " = " + formatter.format(res);
                outPut.println(str);
    ...
    private void competenceCalculate() {
        ...
        for (int cr = 0; cr < Criterions.getSize(); cr++) {
            ...
            outPut.println();
            outPut.println(
                    "Начальные значения коэффициентов компетентности экспертов ( формула: Koj = 1 / m )");
            outPut.println();
            ...
            outPut.println();
            outPut.println(
                    "Расчет групповых оценок объектов ( формула: X1i = Σj (Xij / m) ) и величины λ1,i ( формула: X1i = Σj (Xij)");
            outPut.println();
            str3 = "λ1 = ";
            ...
            outPut.println();
            outPut.println(
                    "Расчет коэффициентов компетентности ( формула: K1,j = (Σi (Xij * X1i)) / λ1 )");
            outPut.println();
            ...
            for (int ex = 0; ex < Experts.getSize(); ex++) {
                ...
                str1 =
                        str1.substring(0, str1.length() - 3)
                                + " = "
                                + formatter.format(competence1[ex]);
                outPut.println(str1);
            }
            ...
            outPut.println();
            outPut.println(
                    "Начальные значения коэффициентов компетентности экспертов ( формула: Kj = Σi (X2i) / λ2 )");
            outPut.println();
            ...
            outPut.println();
            outPut.println(
                    "Расчет групповых оценок объектов ( формула: X2i = Σj (Xij / m) ) и величины λ2i ( формула: X2i = Σj (Xij)");
            outPut.println();
            str3 = "λ2 = ";
            ...
            outPut.println();
            outPut.println(
                    "Расчет коэффициентов компетентности ( формула: K2j = (Σi (Xij * X2i)) / λ2 )");
            outPut.println();
    ...
    private void newCompetenceCalculate() {
        outPut.println();
        outPut.println(
                "Расчет новых общих коэффициентов компетентности экспертов на основе выполненных "
        ...
        for (int ex = 0; ex < Experts.getSize(); ex++) {
            ...
            str =
                    str.substring(0, str.length() - 3)
                            + ") / 4 = "
                            + formatter.format(newCompetence[ex]);
            outPut.println(str);
        }
        outPut.println();
    }
    ...
    private void newMidCriterionWeightsCalculate() {
        outPut.println();
        outPut.println(
                "Расчет новых средних значений коэффициентов весов показателей сравнения объектов "
            ...
            for (int ex = 0; ex < Experts.getSize(); ex++) {
                ...
                str =
                        str
                                ...
                                + formatter.format(Criterions.findCriterion(cr).getWeight(ex))
                                + " * "
                                + formatter.format(competence[cr][ex])
                                + ") + ";
            }
    ...
    private void newMidMarksCalculate() {
        ...
        outPut.println();
        outPut.println(
                "Расчет новых средних значений оценок объектов на основе выполненных расчетов "
    ...
    private void theBestObjectCalculate() {
        ...
        outPut.println(
                "НАИБОЛЕЕ ПРЕДПОЧТИТЕЛЬНЫЙ ОБЪЕКТ: №"
                        + (theBestObject + 1)
                        + ", "
