...
public class MainForm extends JFrame {
    ...
    private JPanel setPrimaryDataPanel, calculatePanel, panelMethod3, panelMethod1, panelMethod5,
            panelMethod4, panelMethod2;

    private JLabel labelChooseCriterion, labelExperts, labelObjects, labelCriterions, labelBackToEdit,
            labelMethodName1, labelMethodName2, labelMethodName3, labelMethodName4, labelMethodName5,
            labelDiscriptionMethod1, labelDiscriptionMethod2, labelDiscriptionMethod3, labelDiscriptionMethod4, labelDiscriptionMethod5,
            labelBackToChoose, labelBestObjValue1Method2, labelBestObjValue2Method2, labelResMethod3,
            labelBestObjValueMethod4, labelSpearmanResult, labelKendallResult;

    private DefaultListModel listModelExperts, listModelExpertsK, listModelObjects, listModelCriterions;
    ...
    private JScrollPane scrollPaneExpertsList, scrollPaneExpertsKList, scrollPaneObjectsList, scrollPaneCriterionsList, scrollPaneTable,
            scrollPaneTable1Method1, scrollPaneTable2Method1, scrollPaneTable3Method1, scrollPaneTable4Method1,
            scrollPaneTable1Method2, scrollPaneTable2Method2, scrollPaneTable3Method2, scrollPaneTable4Method2, scrollPaneTable5Method2,
            scrollPaneTable1Method3, scrollPaneTable2Method3, scrollPaneTable3Method3, scrollPaneTextAreaMethod3,
            scrollPaneTable1Method4, scrollPaneTable2Method4, scrollPaneTable3Method4, scrollPaneTable4Method4,
            scrollPaneTable1Method5, scrollPaneTable2Method5, scrollPaneTextArea1Method5, scrollPaneTextArea2Method5;

    private JComboBox comboBoxCriterions, comboBoxCriterions1Method2, comboBoxCriterions2Method2, comboBoxMethod3,
            comboBoxCriterionsMethod4, comboBoxCriterionsMethod5;

    private JButton buttonAddExpert, buttonAddObject, buttonAddCriterion,
            buttonDelExpert, buttonDelObject, buttonDelCriterion,
            buttonNext, buttonSaveMarks, buttonPrev, buttonGoToCalculate,
            buttonGoToMethod1, buttonGoToMethod2, buttonGoToMethod3, buttonGoToMethod4, buttonGoToMethod5,
            showResultsMethod1, showResultsMethod2, showResultsMethod3, showResultsMethod4, showResultsMethod5;

    private JTable tableMarks, table1Method1, table2Method1, table3Method1, table4Method1,
            table1Method2, table2Method2, table3Method2, table4Method2, table5Method2,
            table1Method3, table2Method3, table3Method3,
            table1Method4, table2Method4, table3Method4, table4Method4,
            table1Method5, table2Method5;

    private DefaultTableModel tableModel, tableModel1Method1, tableModel2Method1, tableModel3Method1, tableModel4Method1,
            tableModel1Method2, tableModel2Method2, tableModel3Method2, tableModel4Method2, tableModel5Method2,
            tableModel1Method3, tableModel2Method3, tableModel3Method3,
            tableModel1Method4, tableModel2Method4, tableModel3Method4, tableModel4Method4,
            tableModel1Method5, tableModel2Method5;
    ...
    private void addScrollPanes() {
        ...
        scrollPaneCriterionsList.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
    ...
    private void addComboBoxes() {
        ...
        prevComboBoxValue = 0;
        comboBoxCriterions.addActionListener(e1 -> {
            if (prevComboBoxValue > -1 && prevComboBoxValue != comboBoxCriterions.getSelectedIndex()) {
                tableModel.setDataVector(appController.getDataForMarksTable(comboBoxCriterions.getSelectedIndex(),
                        listModelExperts), appController.getObjectHeadersForTable(listModelObjects));
            }
    ...
    private void addButtons() {
        ...
        buttonAddExpert.addActionListener(e -> {
            boolean isOk = appController.onAddExpert(textFieldExperts.getText(), textFieldExpertsK.getText(),
                    listModelExperts, listModelExpertsK);
            if(isOk) {
        ...
        buttonAddCriterion.addActionListener(e -> {
            appController.onAddCriterion(textFieldCriterions.getText(), listModelCriterions);
        ...
        buttonDelExpert.addActionListener(e -> {
            appController.onDelExpert(listExperts.getSelectedIndex(), listModelExperts, listModelExpertsK);
        });

        buttonDelObject = new JButton("Удалить");
        buttonDelObject.setBounds(385, 270, 90, 30);
        setPrimaryDataPanel.add(buttonDelObject);
        buttonDelObject.addActionListener(e -> {
        ...
        buttonDelCriterion.addActionListener(e -> {
           appController.onDelCriterion(listCriterions.getSelectedIndex(), listModelCriterions);
        });
        ...
        buttonNext.addActionListener(e -> {
            if(listModelExperts.getSize() == 0) {
                JOptionPane.showMessageDialog(null, "Список экспертов пуст!", "Ошибка", JOptionPane.ERROR_MESSAGE);
                return;
            }
            if(listModelObjects.getSize() == 0) {
                JOptionPane.showMessageDialog(null, "Список объектов пуст!", "Ошибка", JOptionPane.ERROR_MESSAGE);
                return;
            }
            if(listModelCriterions.getSize() == 0) {
                JOptionPane.showMessageDialog(null, "Список критериев пуст!", "Ошибка", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            tableModel.setDataVector(appController.getDataForMarksTable(0, listModelExperts),
        ...
        buttonSaveMarks.addActionListener(e1 -> {
        ...
        buttonGoToCalculate.addActionListener(e1 -> {
        ...
        buttonPrev.addActionListener(e1 -> {
    ...
    private void buildCalculatePanel() {
        ...
        //Labels
        labelMethodName1 = new JLabel("1. Составление групповых оценок по методу непосредственной оценки");
        ...
        labelBackToEdit.addMouseListener(new MouseAdapter() {
            @Override
        ...
        labelDiscriptionMethod1 = new JLabel("<html><font color=\"696969\"><i>Результаты оценки представляют собой числа " +
        ...
        labelDiscriptionMethod1.setFont(new Font(labelDiscriptionMethod1.getFont().getName(), Font.PLAIN, 12));
        calculatePanel.add(labelDiscriptionMethod1);

        labelDiscriptionMethod2 = new JLabel("<html><font color=\"696969\"><i>По результатам экспертной процедуры " +
        ...
        labelDiscriptionMethod2.setFont(new Font(labelDiscriptionMethod2.getFont().getName(), Font.PLAIN, 12));
        calculatePanel.add(labelDiscriptionMethod2);

        labelDiscriptionMethod3 = new JLabel("<html><font color=\"696969\"><i>При ранжировании объектов эксперты обычно " +
        ...
        labelDiscriptionMethod3.setFont(new Font(labelDiscriptionMethod3.getFont().getName(), Font.PLAIN, 12));
        calculatePanel.add(labelDiscriptionMethod3);

        labelDiscriptionMethod4 = new JLabel("<html><font color=\"696969\"><i>При решении задачи оценки большого числа " +
        ...
        labelDiscriptionMethod4.setFont(new Font(labelDiscriptionMethod4.getFont().getName(), Font.PLAIN, 12));
        calculatePanel.add(labelDiscriptionMethod4);

        labelDiscriptionMethod5 = new JLabel("<html><font color=\"696969\"><i>При обработке результатов ранжирования " +
        ...
        labelDiscriptionMethod5.setFont(new Font(labelDiscriptionMethod5.getFont().getName(), Font.PLAIN, 12));
        ...
        buttonGoToMethod1.addActionListener(e -> {
            calculatePanel.setVisible(false);
        ...
        buttonGoToMethod2.addActionListener(e -> {
            calculatePanel.setVisible(false);
        ...
        buttonGoToMethod3.addActionListener(e -> {
            calculatePanel.setVisible(false);
            if(panelMethod3 == null) {
                appController.calculateMethod3(Method3.DEF_A_INDEX, String.valueOf(Method3.DEF_A));
                buildPanelMethod3();
            } else {
        ...
        buttonGoToMethod4.addActionListener(e -> {
            calculatePanel.setVisible(false);
        ...
        buttonGoToMethod5.addActionListener(e -> {
            calculatePanel.setVisible(false);
        ...
        labelBackToChoose.addMouseListener(new MouseAdapter() {
            @Override
            public void mousePressed(MouseEvent e) {
    ...
    private void buildPanelMethod1() {
        ...
        //Labels
        JLabel labelTitle = new JLabel("Составление групповых оценок по методу непосредственной оценки");
        ...
        JLabel labelMidMarks = new JLabel("Средние значения значений коэффициентов весов показателей объектов");
        ...
        JLabel labelBestObj = new JLabel("Наиболее предпочтительный объект: " + appController.getResultMethod1());
        ...
        //Tables
        tableModel1Method1 = new DefaultTableModel(appController.getDataTable1Method1(),
        ...
        scrollPaneTable1Method1.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        panelMethod1.add(scrollPaneTable1Method1);

        tableModel2Method1 = new DefaultTableModel(appController.getDataTable2Method1(),
        ...
        scrollPaneTable2Method1.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        panelMethod1.add(scrollPaneTable2Method1);

        tableModel3Method1 = new DefaultTableModel(appController.getDataTable3Method1(),
                appController.getObjectHeadersForTable(listModelObjects));
        ...
        scrollPaneTable3Method1.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        scrollPaneTable3Method1.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
        panelMethod1.add(scrollPaneTable3Method1);

        tableModel4Method1 = new DefaultTableModel(appController.getDataTable4Method1(),
        ...
        scrollPaneTable4Method1.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
        ...
        showResultsMethod1.addActionListener(e1 -> {
            new ResultForm("Ход составления групповых оценок по методу непосредственной оценки", Method1.FILENAME);
        });
    ...
    private void buildPanelMethod2() {
        ...
        labelBestObjValue1Method2.setFont(new Font(labelBestObjValue1Method2.getFont().getName(), Font.PLAIN, 16));
        ...
        labelBestObjValue2Method2.setFont(new Font(labelBestObjValue2Method2.getFont().getName(), Font.PLAIN, 16));
        panelMethod2.add(labelBestObjValue2Method2);

        //Tables
        tableModel1Method2 = new DefaultTableModel(appController.getDataTable1Method2(0),
                appController.getObjectHeadersForTable(listModelObjects));
        ...
        scrollPaneTable1Method2.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        scrollPaneTable1Method2.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
        panelMethod2.add(scrollPaneTable1Method2);

        tableModel2Method2 = new DefaultTableModel(appController.getDataTable2Method2(0),
                appController.getSumHeadersForTable());
        ...
        scrollPaneTable2Method2.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
        panelMethod2.add(scrollPaneTable2Method2);

        tableModel3Method2 = new DefaultTableModel(appController.getDataTable3Method2(0),
                appController.getObjectHeadersForTable(listModelObjects));
        ...
        scrollPaneTable3Method2.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        scrollPaneTable3Method2.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
        panelMethod2.add(scrollPaneTable3Method2);

        tableModel4Method2 = new DefaultTableModel(appController.getDataTable4Method2(0),
                appController.getSumHeadersForTable());
        ...
        scrollPaneTable4Method2.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
        panelMethod2.add(scrollPaneTable4Method2);

        tableModel5Method2 = new DefaultTableModel(appController.getDataTable5Method2(0),
        ...
        scrollPaneTable5Method2.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
        ...
        comboBoxCriterions1Method2.addActionListener(e1 -> {
            int cr = comboBoxCriterions1Method2.getSelectedIndex();
            if(prevComboBoxValue1Method2 > -1 && prevComboBoxValue1Method2 != cr) {
                tableModel1Method2.setDataVector(appController.getDataTable1Method2(cr),
                        appController.getObjectHeadersForTable(listModelObjects));
                tableModel2Method2.setDataVector(appController.getDataTable2Method2(cr),
                        appController.getSumHeadersForTable());
        ...
        comboBoxCriterions2Method2.addActionListener(e1 -> {
            int cr = comboBoxCriterions2Method2.getSelectedIndex();
            if(prevComboBoxValue2Method2 > -1 && prevComboBoxValue2Method2 != cr) {
                tableModel3Method2.setDataVector(appController.getDataTable3Method2(cr),
                        appController.getObjectHeadersForTable(listModelObjects));
                tableModel4Method2.setDataVector(appController.getDataTable4Method2(cr),
                        appController.getSumHeadersForTable());
                tableModel5Method2.setDataVector(appController.getDataTable5Method2(cr),
                        appController.getRangHeadersForTable());
        ...
        showResultsMethod2.addActionListener(e1 -> {
            new ResultForm("Ход выполнения обобщенной ранжировки на основе ранговой корреляции", Method2a.FILENAME);
            new ResultForm("Ход выполнения обобщенной ранжировки на основе парных сравнений", Method2b.FILENAME);
        });
    ...
    private void buildPanelMethod3() {
        ...
        comboBoxMethod3.addActionListener(e1 -> {
            int cr = comboBoxMethod3.getSelectedIndex();
            if (prevComboBoxValueMethod3 > -1 && prevComboBoxValueMethod3 != cr) {
                appController.calculateMethod3(comboBoxMethod3.getSelectedIndex(),
        ...
        //Tables
        tableModel1Method3 = new DefaultTableModel(appController.getDataTable1Method3(),
        ...
        scrollPaneTable1Method3.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        scrollPaneTable1Method3.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
        panelMethod3.add(scrollPaneTable1Method3);

        tableModel2Method3 = new DefaultTableModel(appController.getDataTable2Method3(),
        ...
        scrollPaneTable2Method3.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        scrollPaneTable2Method3.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
        panelMethod3.add(scrollPaneTable2Method3);

        tableModel3Method3 = new DefaultTableModel(appController.getDataTable3Method3(),
        ...
        scrollPaneTable3Method3.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        scrollPaneTable3Method3.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
        ...
        scrollPaneTextAreaMethod3.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        scrollPaneTextAreaMethod3.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
        ...
        showResultsMethod3.addActionListener(e1 -> {
            new ResultForm("Ход расчета оценки согласованности мнений экспертов", Method3.FILENAME);
        });
    ...
    private void buildPanelMethod4() {
        ...
        JLabel labelX2 = new JLabel("Матрица математических ожиданий оценок пар объектов в квадрате");
        ...
        labelBestObjValueMethod4.setFont(new Font(labelBestObjValueMethod4.getFont().getName(), Font.PLAIN, 16));
        panelMethod4.add(labelBestObjValueMethod4);

        //Tables
        tableModel1Method4 = new DefaultTableModel(appController.getDataTable1Method4(0),
                appController.getObjectHeadersForTable(listModelObjects));
        ...
        scrollPaneTable1Method4.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        scrollPaneTable1Method4.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
        panelMethod4.add(scrollPaneTable1Method4);

        tableModel2Method4 = new DefaultTableModel(appController.getDataTable2Method4(0),
        ...
        scrollPaneTable2Method4.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
        panelMethod4.add(scrollPaneTable2Method4);

        tableModel3Method4 = new DefaultTableModel(appController.getDataTable3Method4(0),
                appController.getObjectHeadersForTable(listModelObjects));
        ...
        scrollPaneTable3Method4.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        scrollPaneTable3Method4.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
        panelMethod4.add(scrollPaneTable3Method4);

        tableModel4Method4 = new DefaultTableModel(appController.getDataTable4Method4(0),
        ...
        scrollPaneTable4Method4.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
        ...
        comboBoxCriterionsMethod4.addActionListener(e1 -> {
            int cr = comboBoxCriterionsMethod4.getSelectedIndex();
            if(prevComboBoxValueMethod4 > -1 && prevComboBoxValueMethod4 != cr) {
                tableModel1Method4.setDataVector(appController.getDataTable1Method4(cr),
                        appController.getObjectHeadersForTable(listModelObjects));
                tableModel2Method4.setDataVector(appController.getDataTable2Method4(cr),
                        appController.getHeadersTable2Method4());
                tableModel3Method4.setDataVector(appController.getDataTable3Method4(cr),
                        appController.getObjectHeadersForTable(listModelObjects));
                tableModel4Method4.setDataVector(appController.getDataTable4Method4(cr),
                        appController.getHeadersTable4Method4());
        ...
        showResultsMethod4.addActionListener(e1 -> {
    ...
    private void buildPanelMethod5() {
        ...
        labelSpearmanResult.setFont(new Font(labelSpearmanResult.getFont().getName(), Font.PLAIN, 16));
        ...
        labelKendallResult.setFont(new Font(labelKendallResult.getFont().getName(), Font.PLAIN, 16));
        panelMethod5.add(labelKendallResult);

        //Tables
        tableModel1Method5 = new DefaultTableModel(appController.getDataTable1Method5(0),
        ...
        scrollPaneTable1Method5.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        scrollPaneTable1Method5.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
        panelMethod5.add(scrollPaneTable1Method5);

        tableModel2Method5 = new DefaultTableModel(appController.getDataTable2Method5(0),
                appController.getExpertHeadersForTable(listModelExperts));
        ...
        scrollPaneTable2Method5.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        scrollPaneTable2Method5.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
        ...
        scrollPaneTextArea1Method5.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        scrollPaneTextArea1Method5.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
        ...
        scrollPaneTextArea2Method5.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        scrollPaneTextArea2Method5.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
        ...
        comboBoxCriterionsMethod5.addActionListener(e1 -> {
            int cr = comboBoxCriterionsMethod5.getSelectedIndex();
            if(prevComboBoxValueMethod5 > -1 && prevComboBoxValueMethod5 != cr) {
                tableModel1Method5.setDataVector(appController.getDataTable1Method5(cr),
                        appController.getExpertHeadersForTable(listModelExperts));
                tableModel2Method5.setDataVector(appController.getDataTable2Method5(cr),
                        appController.getExpertHeadersForTable(listModelExperts));
            }
        ...
        showResultsMethod5.addActionListener(e1 -> {
